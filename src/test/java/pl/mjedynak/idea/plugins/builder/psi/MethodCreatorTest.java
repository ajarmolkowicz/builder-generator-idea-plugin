...
import static org.mockito.BDDMockito.lenient; // Added
...
public class MethodCreatorTest {
    ...
    void shouldCreateSingleMethodForNonOptionalField() {
        ...
        // when
        List<PsiMethod> result = methodCreator.createSetterMethods(psiField, methodPrefix, srcClassFieldName, false);
    ...
    @Test
    void shouldCreateSingleMethodForNonOptionalFieldWithSingleField() {
        // given
        mockFieldType(stringType, "String", "java.lang.String");
        // Real MethodNameCreator will be used, "setName" is the expected outcome for ("set", "name")
        String expectedMethodText = "public " + builderClassName + " " + methodName + "(String " + fieldName + ") { "
                + srcClassFieldName + ".setName(" + fieldName + "); return this; }";
        given(elementFactory.createMethodFromText(expectedMethodText, psiField)).willReturn(mockMethod);

        // when
        List<PsiMethod> result = methodCreator.createSetterMethods(psiField, methodPrefix, srcClassFieldName, true);
    ...
    @Test
    void shouldCreateTwoMethodsForOptionalFieldWithSingleField() {
        // given
        mockFieldType(optionalStringType, "Optional<String>", "java.util.Optional<java.lang.String>");
        lenient().when(optionalStringType.getParameters()).thenReturn(new PsiType[] {stringType});
        lenient().when(stringType.getPresentableText()).thenReturn("String");
        // Real MethodNameCreator will be used, "setName" is the expected outcome for ("set", "name")
        ...
        String expectedRawMethodText = "public " + builderClassName + " " + methodName + "(String " + fieldName + ") { "
                + srcClassFieldName + ".setName(Optional.of(" + fieldName + ")); return this; }";
        String expectedOptionalMethodText = "public " + builderClassName + " " + methodName + "(Optional<String> "
                + fieldName + ") { " + srcClassFieldName + ".setName(" + fieldName + "); return this; }";
